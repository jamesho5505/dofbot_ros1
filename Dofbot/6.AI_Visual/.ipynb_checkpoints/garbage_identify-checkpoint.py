...
class garbage_identify:
    def __init__(self):
        ...
        self.anchors_path = '/root/dofbot_ws/src/dofbot_garbage_yolov4_tiny/model_data/yolo_anchors.txt'
        self.classes_path = '/root/dofbot_ws/src/dofbot_garbage_yolov4_tiny/model_data/garbage.txt'
        self.model_path = '/root/dofbot_ws/src/dofbot_garbage_yolov4_tiny/model_data/garbage.h5'
        self.font_path = '/root/dofbot_ws/src/dofbot_garbage_yolov4_tiny/font/Block_Simplified.TTF'
